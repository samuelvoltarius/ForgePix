...
class MainWindow(WelcomeMixin, SettingsMixin, ExportMixin, ResultMixin, QMainWindow):
    def __init__(self):
        ...
        self.astro_stretch = QCheckBox(tr("Anzeige strecken (sonst schwarz)")); self.astro_stretch.setChecked(True)
        self.astro_stretch_mode = QComboBox()
        self.astro_stretch_mode.addItem(tr("MTF / Histogramm (Standard, farbneutral)"), "mtf")
        self.astro_stretch_mode.addItem(tr("asinh"), "asinh")
        ...
        self.astro_sat.setSingleStep(0.05); self.astro_sat.setValue(1.05)
