...
class SettingsMixin:
    ...
    def _settings_map(self):
        return {
            ...
            "astro_stil": (lambda v: self.astro_stil.setCurrentIndex(int(v)), self.astro_stil.currentIndex),
            "astro_erweitert": (lambda v: self.astro_erweitert.setChecked(bool(int(v))),
                                lambda: int(self.astro_erweitert.isChecked())),
            "astro_banding": (lambda v: self.astro_banding.setValue(float(v)), self.astro_banding.value),
            "astro_banding_vert": (lambda v: self.astro_banding_vert.setChecked(bool(int(v))),
                                   lambda: int(self.astro_banding_vert.isChecked())),
            "astro_unclip": (lambda v: self.astro_unclip.setChecked(bool(int(v))),
                             lambda: int(self.astro_unclip.isChecked())),
            "astro_star_reduce": (lambda v: self.astro_star_reduce.setValue(float(v)),
                                  self.astro_star_reduce.value),
            "astro_starless_stretch": (lambda v: self.astro_starless_stretch.setValue(float(v)),
                                       self.astro_starless_stretch.value),
            "astro_color_stretch": (lambda v: self.astro_color_stretch.setValue(float(v)),
                                    self.astro_color_stretch.value),
            "astro_unpurple": (lambda v: self.astro_unpurple.setValue(float(v)),
            ...
            "astro_nebelkontrast": (lambda v: self.astro_nebelkontrast.setValue(float(v)),
                                    self.astro_nebelkontrast.value),
